...
// Upload project to Google Drive (Sửa lỗi lặp Prompt)
export async function uploadProjectToGDrive(customName = '') {
    ...
    // Nếu customName rỗng, tự động lấy defaultName thay vì hiện prompt lần nữa
...
// Download and import project directly via official Google Drive API
