...
export async function executeTextTranslationStep({
    ...
    const transSystemInstruction = [
        ...
        multimodalGuidance,
        `NATURAL MANGA CADENCE & EMOTIONAL FIDELITY: Ensure ${targetLangName} translations flow with authentic conversational rhythm, emotional nuance, and publication-grade prose. Match the character's personality and tone: romance and slice-of-life scenes must be tender, natural, and expressive with proper pronouns and gentle sentence-ending particles, while action scenes should be sharp and spirited. Do NOT over-prune or cut words so aggressively that dialogue becomes curt, cold, or robotic.`,
