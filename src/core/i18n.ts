...
export const i18nDict: Record<string, Record<string, string>> = {
    vi: {
        ...
        "translated-text-placeholder": "Nhập nội dung bản dịch...",
        "translate-block-btn": "Dịch ô này",
        "font-family-label": "Phông chữ:",
        "font-size-label": "Cỡ chữ:",
        ...
        "lasso-fill-btn": "Vẽ bù PatchMatch (Content-Aware Fill)",
        "lasso-clear-btn": "Hủy chọn",
        "lasso-tab-ai": "Bù nền PatchMatch",
    ...
    en: {
        ...
        "lasso-fill-btn": "PatchMatch Inpaint",
        "lasso-clear-btn": "Deselect",
        "lasso-tab-ai": "PatchMatch Inpaint",
