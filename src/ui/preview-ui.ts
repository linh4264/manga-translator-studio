import { globalState, activatePage, garbageCollectPageCaches } from '../core/state';
import { elements } from '../core/elements';
import { showToast, waitForNextPaint } from '../core/utils';
import { renderOverlays } from '../features/canvas/canvas-service';

export let previewCurrentPage = 0;

export function openPreviewMode(): void {
...
export async function renderPreviewPage(): Promise<void> {
